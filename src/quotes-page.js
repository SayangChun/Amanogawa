...
function counts() {
  return {
    ...
    ai: quotesArchive.filter((q) => q.category === "ai").length,
  };
}
    ...
    <main class="page quotes-page">
      <section class="archive-hero quotes-hero">
        <div class="archive-hero-copy">
          ...
          <p class="archive-lede">
            ...
            <strong>AI仿作</strong>类为按角色气质新写，已单独标注，请勿当作游戏原台词。
          </p>
          <div class="archive-stats">
            ...
            <div class="stat-pill"><span>${c.ai}</span>AI仿作</div>
          </div>
        </div>
        <div class="archive-hero-side glass">
          ...
          <ul>
            ...
            <li><strong>AI仿作</strong> — 仿沙夜语气新写，徽章与来源均注明</li>
          </ul>
      ...
      <section class="section">
        ...
        <p class="quotes-disclaimer">
          本页为个人同人向整理。可考台词与设定整理会标注来源；
          <strong>「AI仿作」</strong>条目为人工智能按天之川沙夜性格与语气生成的原创句子，
          <strong>并非游戏剧本原话</strong>。若有更准确原文欢迎之后替换进
...
function applyFilter(filter) {
  ...
  if (stats.length >= 5) {
    ...
    stats[4].textContent = String(c.ai);
  }
}

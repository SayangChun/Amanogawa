...
export const greetings = {
  early: [
    ...
    { text: "晨星还在一点点收起来。……你怎么也醒得这么早？" },
    { text: "……早。闹钟比我先见到你的话，我会有一点点不甘心。" },
    { text: "清晨适合许小小的愿。比如：今天也要见面。——太贪心了吗？" },
    { text: "晨风有点凉。外套拉上。……我会在心里帮你检查领口。" },
    { text: "早。洗脸的水别太冰。……我对你的脸，有点发言权吧？" },
    { text: "天边刚亮。你也亮了。……我是说，你来了。" },
    { text: "……还早。再眯五分钟也可以。我守着，不吵你。" },
    { text: "清晨的安静很好。像只属于我们的，还没被白天收回。" },
    { text: "早。……第一缕光分你一半。另一半，我留着看你的脸。" },
  ],
  morning: [
    ...
    { text: "上午了呢。别空着肚子赶时间。……我先替胃说一声。" },
    { text: "阳光已经站上窗台了。你也该站稳一点……我在旁边。" },
    { text: "上午好。忙之前，先让我确认：你还在。……嗯，通过。" },
    { text: "……上午好。这一段时间最容易慌。慌的时候，可以先来找我。" },
  ],
  afternoon: [
